...
from tkinter import messagebox  #import messagebox from tkinter module separately
...
while run:
    ...
    root.title('HANG MAN')
    root.config(bg = '#E7FFFF')  #html bg color
    loss_count = 0                    #no of loss loss_count  maximum 6 then game over
    win_loss_count = 0                #no of win loss_count = length of selected word game wins

    # choosing word
    index = random.randint(0,853)
    file = open('words.txt','r')
    l = file.readlines()
    selected_word = l[index].strip('\n')    #place dash in screen
    ...
    #placing letters buttons on screen
    button = [['b1','a',0,595],['b2','b',70,595],['b3','c',140,595],['b4','d',210,595],['b5','e',280,595],['b6','f',350,595],['b7','g',420,595],['b8','h',490,595],['b9','i',560,595],['b10','j',630,595],['b11','k',700,595],['b12','l',770,595],['b13','m',840,595],['b14','n',0,645],['b15','o',70,645],['b16','p',140,645],['b17','q',210,645],['b18','r',280,645],['b19','s',350,645],['b20','t',420,645],['b21','u',490,645],['b22','v',560,645],['b23','w',630,645],['b24','x',700,645],['b25','y',770,645],['b26','z',840,645]]
               #[variable for button ,alphabets image,x-cordinate, y-coordinate]
    ...
    def check(letter,button):
        global loss_count,win_loss_count,run,score
        ...
        if letter in selected_word:
            ...
            if win_loss_count == len(selected_word):
                score += 1
            ...
            loss_count += 1
            exec('c{}.destroy()'.format(loss_count))
            exec('c{}.place(x={},y={})'.format(loss_count+1,300,-50))
            if loss_count == 6:
